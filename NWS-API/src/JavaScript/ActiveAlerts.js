...
function request_active_alerts2() {
    fetch(`https://api.weather.gov/alerts/active`, {headers: global_header2}).then(response => response.text()).then(data => {
