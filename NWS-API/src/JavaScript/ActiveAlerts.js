...
function remove_bad_literals(desc) { desc = desc.replace(/\n/g, ' ');desc = desc.replace(/\r/g, ' ');desc = desc.replace(/\t/g, ' ');desc = desc.replace(/\"/g, ' ');desc = desc.replace(/\'/g, ' ');desc = desc.replace(/\//g, ' ');desc = desc.replace(/\-/g, ' ');desc = desc.replace(/\_/g, ' ');return desc;}
